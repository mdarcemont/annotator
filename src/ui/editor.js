...
Editor.template = [
    ...
    '                   <a href="#cancel" class="annotator-cancel annotator-focus ui mini compact right floated button">Annuler</a>',
    '                   <a href="#save" class="annotator-save annotator-focus ui mini compact right floated approve primary button">Enregistrer</a>',
    '               </div>',
    '           </form>',
    '       </div>',
    '   </div>',
